    ...
    <header className="head">
      <nav className='nav sub'>
        ...
        <div className='navRes'>
          <NavLink className='navButton' exact to="/result" title="과제목록"><i className="ri-todo-line"></i></NavLink>
          <NavLink className='navButton' exact to="/form" title="과제등록"><i className="ri-pencil-line"></i></NavLink>
        </div>
