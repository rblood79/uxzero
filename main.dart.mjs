...
_1508: x0 => x0.length,
_1985: x0 => new Array(x0),
_2018: (decoder, codeUnits) => decoder.decode(codeUnits),
_2019: () => new TextDecoder("utf-8", {fatal: true}),
_2020: () => new TextDecoder("utf-8", {fatal: false}),
_2021: v => v.toString(),
_2022: (d, digits) => d.toFixed(digits),
_2026: x0 => new WeakRef(x0),
_2027: x0 => x0.deref(),
_2033: Date.now,
_2035: s => new Date(s * 1000).getTimezoneOffset() * 60 ,
_2036: s => {
...
_2038: () => typeof dartUseDateNowForTicks !== "undefined",
_2039: () => 1000 * performance.now(),
_2040: () => Date.now(),
_2043: () => new WeakMap(),
_2044: (map, o) => map.get(o),
_2045: (map, o, v) => map.set(o, v),
_2046: () => globalThis.WeakRef,
_2057: s => JSON.stringify(s),
_2058: s => printToConsole(s),
_2059: a => a.join(''),
_2062: (s, t) => s.split(t),
_2063: s => s.toLowerCase(),
_2064: s => s.toUpperCase(),
_2065: s => s.trim(),
_2066: s => s.trimLeft(),
_2067: s => s.trimRight(),
_2069: (s, p, i) => s.indexOf(p, i),
_2070: (s, p, i) => s.lastIndexOf(p, i),
_2072: Object.is,
_2073: s => s.toUpperCase(),
_2074: s => s.toLowerCase(),
_2075: (a, i) => a.push(i),
_2079: a => a.pop(),
_2080: (a, i) => a.splice(i, 1),
_2082: (a, s) => a.join(s),
_2083: (a, s, e) => a.slice(s, e),
_2086: a => a.length,
_2088: (a, i) => a[i],
_2089: (a, i, v) => a[i] = v,
_2091: (o, offsetInBytes, lengthInBytes) => {
      var dst = new ArrayBuffer(lengthInBytes);
      new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
      return new DataView(dst);
    },
_2092: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
_2093: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
_2094: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
_2095: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
_2096: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
_2097: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
_2098: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
_2100: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
_2101: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
_2102: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
_2103: (t, s) => t.set(s),
_2105: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
_2107: o => o.buffer,
_2108: o => o.byteOffset,
_2109: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
_2110: (b, o) => new DataView(b, o),
_2111: (b, o, l) => new DataView(b, o, l),
_2112: Function.prototype.call.bind(DataView.prototype.getUint8),
_2113: Function.prototype.call.bind(DataView.prototype.setUint8),
_2114: Function.prototype.call.bind(DataView.prototype.getInt8),
_2115: Function.prototype.call.bind(DataView.prototype.setInt8),
_2116: Function.prototype.call.bind(DataView.prototype.getUint16),
_2117: Function.prototype.call.bind(DataView.prototype.setUint16),
_2118: Function.prototype.call.bind(DataView.prototype.getInt16),
_2119: Function.prototype.call.bind(DataView.prototype.setInt16),
_2120: Function.prototype.call.bind(DataView.prototype.getUint32),
_2121: Function.prototype.call.bind(DataView.prototype.setUint32),
_2122: Function.prototype.call.bind(DataView.prototype.getInt32),
_2123: Function.prototype.call.bind(DataView.prototype.setInt32),
_2126: Function.prototype.call.bind(DataView.prototype.getBigInt64),
_2127: Function.prototype.call.bind(DataView.prototype.setBigInt64),
_2128: Function.prototype.call.bind(DataView.prototype.getFloat32),
_2129: Function.prototype.call.bind(DataView.prototype.setFloat32),
_2130: Function.prototype.call.bind(DataView.prototype.getFloat64),
_2131: Function.prototype.call.bind(DataView.prototype.setFloat64),
_2145: (o, t) => o instanceof t,
...
_2149: o => Object.keys(o),
_2150: (ms, c) =>
              setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
_2151: (handle) => clearTimeout(handle),
_2152: (ms, c) =>
          setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
_2153: (handle) => clearInterval(handle),
_2154: (c) =>
...
_2194: (x0,x1) => x0.test(x1),
_2195: (x0,x1) => x0.exec(x1),
_2196: (x0,x1) => x0.exec(x1),
_2197: x0 => x0.pop(),
_2201: (x0,x1,x2) => x0[x1] = x2,
_2203: o => o === undefined,
_2204: o => typeof o === 'boolean',
_2205: o => typeof o === 'number',
_2207: o => typeof o === 'string',
_2210: o => o instanceof Int8Array,
_2211: o => o instanceof Uint8Array,
_2212: o => o instanceof Uint8ClampedArray,
_2213: o => o instanceof Int16Array,
_2214: o => o instanceof Uint16Array,
_2215: o => o instanceof Int32Array,
_2216: o => o instanceof Uint32Array,
_2217: o => o instanceof Float32Array,
_2218: o => o instanceof Float64Array,
_2219: o => o instanceof ArrayBuffer,
_2220: o => o instanceof DataView,
_2221: o => o instanceof Array,
_2222: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_2224: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_2225: o => o instanceof RegExp,
_2226: (l, r) => l === r,
_2227: o => o,
_2228: o => o,
_2229: o => o,
...
_2231: o => o.length,
_2234: (o, i) => o[i],
_2235: f => f.dartFunction,
_2236: l => arrayFromDartList(Int8Array, l),
_2237: (data, length) => {
...
_2238: l => arrayFromDartList(Uint8ClampedArray, l),
_2239: l => arrayFromDartList(Int16Array, l),
_2240: l => arrayFromDartList(Uint16Array, l),
_2241: l => arrayFromDartList(Int32Array, l),
_2242: l => arrayFromDartList(Uint32Array, l),
_2243: l => arrayFromDartList(Float32Array, l),
_2244: l => arrayFromDartList(Float64Array, l),
_2245: (data, length) => {
...
_2246: l => arrayFromDartList(Array, l),
_2247:       (s, length) => {
        if (length == 0) return '';
...
_2256: (o, p) => o[p],
_2257: (o, p, v) => o[p] = v,
_2258: (o, m, a) => o[m].apply(o, a),
_2260: o => String(o),
_2261: (p, s, f) => p.then(s, f),
_2262: s => {
      if (/[[\]{}()*+?.\\^$|]/.test(s)) {
          s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
      }
...
_2269: (x0,x1) => x0[x1],
_2272: x0 => x0.flags,
_2273: x0 => x0.multiline,
_2274: x0 => x0.ignoreCase,
_2275: x0 => x0.unicode,
_2276: x0 => x0.dotAll,
_2277: (x0,x1) => x0.lastIndex = x1,
_4213: () => globalThis.window,
_4260: x0 => x0.location,
_4542: x0 => x0.sessionStorage,
_4558: x0 => x0.hostname
    };
